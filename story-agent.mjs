  ...
  "pages": [
    {
      ...
      "image_Prompt": "string",
      "characters": [
        { "name": "string", "in_scene": "string — what this character is DOING/FEELING in this scene" }
      ]
    }
  ],
...
- Per-page characters array: list characters VISIBLE on that page by name, with an in_scene field describing their pose/action/emotion.
- Animals and things listed in top-level arrays can also appear in per-page characters by name.
